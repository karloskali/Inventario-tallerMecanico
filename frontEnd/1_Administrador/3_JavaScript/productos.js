...
//let urlEditarEliminarProductos = `http://localhost:8081/api/producto/${idProducto}`; 
...
function obtener_producto(id) {
    ...
    var url2 = `http://localhost:8081/api/producto/${idProducto}`
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $("#formEditar #proveedor").val(response.proveedor.id);
            console.log(response.proveedor.id);
        }
    });
}
